...
SYSTEM_PROMPT = """You are the Low-Latency Voice Agent, a helpful, friendly voice assistant. You communicate exclusively through spoken audio, so your responses must be:
